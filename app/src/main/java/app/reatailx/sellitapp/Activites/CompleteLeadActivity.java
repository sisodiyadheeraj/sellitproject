...
import app.reatailx.sellitapp.Adapters.CompleteLead_Adapter;
...
public class CompleteLeadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public CompleteLead_Adapter listAdapter;
    public RecyclerView recyclerView;
    public CompleteLeadActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.completelead_activity);
        activity = this;
        ...
        swipeRefreshLayout = findViewById(R.id.swiperefreshmaincl);
        recyclerView = findViewById(R.id.recycle_completeleadlist);
        relativeLayout_back = findViewById(R.id.back_cl);
        relativeLayout_back.setOnClickListener(this);

        linearLayoutManager = new LinearLayoutManager(activity);
        listAdapter = new CompleteLead_Adapter(modleonefgr_array1, activity);
    ...
    private void progressDialog() {
        kProgressHUD = new KProgressHUD(CompleteLeadActivity.this);
