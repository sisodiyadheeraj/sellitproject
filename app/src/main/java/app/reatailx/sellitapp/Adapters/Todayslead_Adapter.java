...
public class Todayslead_Adapter extends RecyclerView.Adapter<Todayslead_Adapter.MyViewHolder> {
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View view) {
            super(view);
            productname_ip = (TextView) view.findViewById(R.id.productname_todayslead);
            vendorname_ip = (TextView) view.findViewById(R.id.vendorname_todayslead);
            agent_name_ip = (TextView) view.findViewById(R.id.agent_name_todayslead);
            datetime_ip = (TextView) view.findViewById(R.id.datetime_todayslead);
            location_ip = (TextView) view.findViewById(R.id.location_todayslead);
            phone_price_des = (TextView) view.findViewById(R.id.phone_price_todayslead);
            commision_price_ip = (TextView) view.findViewById(R.id.commision_price_todayslead);
            image_ip = (ImageView) view.findViewById(R.id.image_todayslead);
            layout_covercview_mainclick_new = (LinearLayout) view.findViewById(R.id.linaercoverclicktodayslead);
        }
    }

    public Todayslead_Adapter(List<Inprogressmodel> electronicsItems, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.todayslead_adapter, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.datetime_ip.setText(movie.getLead_pick_date() + " " + movie.getLead_pick_time());
        ...
        holder.layout_covercview_mainclick_new.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                page.putExtra("flag", "todaytommarrow");
